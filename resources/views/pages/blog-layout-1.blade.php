...
@section('subhead')
<title>Blog - Bayu - Tailwind HTML Admin Template</title>
@endsection
        ...
        <div class="flex items-center border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4">
            ...
            <div class="ml-3 mr-auto">
                ...
                <div class="flex text-slate-500 truncate text-xs mt-0.5">
                    <a class="text-primary inline-block truncate" href="">{{ $faker['products'][0]['category'] }}</a>
        ...
        <div class="px-5 pt-3 pb-5 border-t border-slate-200/60 dark:border-darkmode-400">
            ...
            <div class="w-full flex items-center mt-3">
                ...
                <div class="flex-1 relative text-slate-600">
                    <input type="text" class="form-control form-control-rounded border-transparent bg-slate-100 pr-10"
